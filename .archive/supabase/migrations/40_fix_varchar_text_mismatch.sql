-- ============================================
-- Migration 40: VARCHAR/TEXT 타입 불일치 수정
-- 실행일: 2025-10-04
-- 목적: 테이블의 실제 타입(VARCHAR)에 맞춰 함수 수정
-- ============================================
...
-- 코멘트
COMMENT ON FUNCTION public.get_aed_data_filtered IS 'AED 데이터 필터링 조회 (VARCHAR 타입 정확히 맞춤)';
