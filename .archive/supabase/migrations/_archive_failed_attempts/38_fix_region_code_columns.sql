-- ============================================
-- Migration 38: region_code/city_code 컬럼 제거
-- 실행일: 2025-10-04
-- 목적: aed_data 테이블에 존재하지 않는 컬럼 제거
-- ============================================
...
-- 수정된 함수 재생성 (region_code, city_code 반환 컬럼 제거)
...
-- 코멘트 추가
COMMENT ON FUNCTION public.get_aed_data_filtered IS 'AED 데이터 필터링 조회 (거리 계산 포함, 거리순 정렬)';
