-- ============================================================================
-- Migration 49: 지역 코드 → 짧은 이름 변환 수정
-- ============================================================================
--
-- 작성일: 2025-10-04
-- 목적: DB에 "서울", "부산" 같은 짧은 이름으로 저장되어 있으므로
--       RPC 함수가 코드를 짧은 이름으로 변환하도록 수정
--
-- 문제점:
-- - RPC 함수가 'SEO' → '서울특별시'로 변환
-- - DB에는 '서울'로 저장됨
-- - 검색 결과 0건
--
-- 해결책:
-- - 'SEO' → '서울'로 변환하도록 매핑 수정
--
-- ============================================================================
...
DECLARE
  region_labels TEXT[];
BEGIN
  -- 지역 코드를 짧은 이름으로 변환 (DB에 저장된 형식과 일치)
...
-- ============================================================================
-- get_aed_data_by_jurisdiction도 같이 수정
-- ============================================================================
