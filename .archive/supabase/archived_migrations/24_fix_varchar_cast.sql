...
BEGIN
  ...
  SELECT
    ad.id::TEXT,
    ad.equipment_serial::TEXT AS device_serial,
    ad.management_number::TEXT,
    ad.installation_institution::TEXT AS installation_org,
    ad.installation_address::TEXT AS address,
    ad.installation_position::TEXT AS detailed_address,
    COALESCE(
      hc.region_code,
    ...
    COALESCE(hc.city_code, ad.gugun)::TEXT AS city_code,
    ad.jurisdiction_health_center::TEXT,
    ...
    ad.institution_contact::TEXT AS contact_phone,
