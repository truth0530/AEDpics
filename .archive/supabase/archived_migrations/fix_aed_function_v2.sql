-- Fix get_aed_data_filtered to include missing parameters and return last_inspection_date

DROP FUNCTION IF EXISTS get_aed_data_filtered(TEXT, TEXT[], TEXT[], TEXT, TEXT[], INT, INT);
